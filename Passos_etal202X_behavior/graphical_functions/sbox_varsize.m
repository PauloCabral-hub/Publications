...
%
% DESCRIPTION: draw a boxplot show each individual sample. Also use komolgorov-smirnov test 
% to verify differences between the distributions. If there are diferences between the dis-
% tributions it shows a horizontal bar connecting the two distributions.
%
% INPUT:
...
%
% OUTPUT:
% AUTHOR: Paulo Roberto Cabral Passos    LAST MODIFIED: 07/08/2020
